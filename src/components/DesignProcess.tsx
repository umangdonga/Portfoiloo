...
export const DesignProcess: React.FC = () => {
  ...
  return (
    <section id="process" className="relative py-16 sm:py-24 px-4 sm:px-6 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6 lg:gap-8 items-stretch">
          {processes.map((card) => (
            <div
              key={card.number}
              className="group relative rounded-2xl sm:rounded-3xl p-5 sm:p-7 md:p-8 bg-[#0d1322]/80 border border-[#2a3050] hover:border-[#4181f0] transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/10 flex flex-col justify-between backdrop-blur-xl h-full"
            >
              <div className="space-y-4 sm:space-y-5">
                {/* Number */}
                <div className="flex items-center justify-between">
                  <span className="text-xl sm:text-2xl font-black text-slate-600 group-hover:text-[#4181f0] transition-colors">
                    {card.number}
                  </span>
                </div>
                ...
                <div className="py-2 sm:py-2.5 px-3 sm:px-3.5 rounded-xl bg-blue-950/40 border border-blue-500/20 text-[#60a5fa] text-[11px] sm:text-xs md:text-[13px] font-medium leading-relaxed tracking-wide">
                  {card.process}
                </div>
              ...
              <div className="mt-5 sm:mt-6 pt-4 sm:pt-5 border-t border-slate-800/80">
                <div className="text-[10px] sm:text-[11px] uppercase tracking-wider font-semibold text-slate-400 mb-1 sm:mb-1.5">
                  Focus
                </div>
                <p className="text-[11px] sm:text-xs md:text-[13px] text-slate-300 font-medium leading-relaxed">
                  {card.focus}
                </p>
              </div>
            </div>
