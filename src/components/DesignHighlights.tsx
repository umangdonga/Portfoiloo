...
export const DesignHighlights: React.FC<DesignHighlightsProps> = ({ onSelectImage }) => {
  ...
  return (
    <section className="relative py-20 overflow-hidden">
      {/* Background Accent */}
      <div className="absolute top-1/2 left-1/3 -translate-y-1/2 w-96 h-96 bg-blue-600/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="animate-marquee flex gap-6 items-center">
          {[...screens, ...screens].map((item, idx) => (
            <div
              ...
              className="group relative w-72 sm:w-88 md:w-96 flex-shrink-0 rounded-2xl overflow-hidden border border-[#2a3050] bg-[#0c101c] p-2 hover:border-[#4181f0] transition-all duration-300 cursor-pointer shadow-xl hover:shadow-blue-500/20 hover:scale-[1.02]"
            >
